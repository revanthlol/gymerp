...
export const metadata = {
  title: "Check-In Turnstiles & Kiosks | GymERP",
  description: "Front-desk check-in turnstiles and member check-in terminal.",
};
...
export default async function StaffKioskPage() {
  ...
  // 1. Fetch multi-kiosk stations and rotating QR code
